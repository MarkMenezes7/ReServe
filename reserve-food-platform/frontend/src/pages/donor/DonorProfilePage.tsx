...
export default function DonorProfilePage() {
  ...
  async function fetchProfile() {
    try {
      setLoading(true);
      const data = await donorApi.getProfile(userId);
      setProfile(data);
      setForm({
        name: data.name || '',
  ...
  async function fetchReviews() {
    try {
      ...
      // Reviews are supplementary; don't block the page
    } finally {
  ...
  async function handleSave(e: FormEvent) {
    ...
    try {
      setSaving(true);
      await donorApi.updateProfile(userId, { ...form } as Record<string, unknown>);
        ...
        <div className="profile-grid">
          ...
          <div className="profile-left">
            ...
            >
              ...
              <span className="profile-badge">Donor</span>
              {profile.createdAt && (
